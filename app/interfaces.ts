...
export interface InfinityMintProjectJavascriptModules extends KeyValue {
    controller?: string;
    minter?: string;
 ...
 */
export interface InfinityMintProjectJavascript extends KeyValue {
    /**
     * will always be true
     */
    javascript?: true;
    ...
    modules?: InfinityMintProjectJavascriptModules;
    paths?: {
        default: InfinityMintProjectPath;
        indexes: InfinityMintProjectPath[];
    };
    /**
    ...
    links?: Dictionary<{
        ...
        deployable: string;
        description: string;
        deployFakeContract: boolean;
        useDefaultLinker: boolean;
 ...
 * For backwards compatability and JavaScript support. A Definition for the classic InfinityMint omega project. Iss used when projects are .js and not .ts before they have been compiled. When they get compiled they get turned into normal project interface. See {@link InfinityMintProject}.
 */
export interface InfinityMintProjectJavascriptDeployed extends KeyValue {
    /**
     * will always be true
     */
    javascript?: true;
    mods?: Dictionary<InfinityMintProjectGem | boolean>;
    contracts?: KeyValue;
    deployment?: KeyValue;
    /**
     * holds variables (numbers and booleans) that were put inside InfinityMintvalues contract
     */
    description?: {
        name: string;
        token: string;
    ...
    paths: InfinityMintProjectPath[];
    assets?: InfinityMintProjectAsset[];
    links?: Dictionary<{
        key: string;
        title: string;
        versionType: string;
...
export interface InfinityMintDeploymentScript {
     ...
     */
    cleanup?: (params: InfinityMintDeploymentParameters) => Promise<string[]>;
