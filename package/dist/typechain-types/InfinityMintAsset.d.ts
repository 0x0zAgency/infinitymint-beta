...
export interface InfinityMintAssetInterface extends utils.Interface {
    functions: {
...
export interface InfinityMintAsset extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: InfinityMintAssetInterface;
...
//# sourceMappingURL=InfinityMintAsset.d.ts.map