...
export interface RarityImageInterface extends utils.Interface {
    functions: {
...
export interface RarityImage extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RarityImageInterface;
...
//# sourceMappingURL=RarityImage.d.ts.map