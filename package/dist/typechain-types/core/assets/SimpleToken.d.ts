...
export interface SimpleTokenInterface extends utils.Interface {
    functions: {
        ...
        "setMintData(uint32,bytes)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setMintData", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "setMintData", data: BytesLike): Result;
...
export interface SimpleToken extends BaseContract {
    ...
    functions: {
        ...
        setMintData(index: PromiseOrValue<BigNumberish>, _mintData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setMintData(index: PromiseOrValue<BigNumberish>, _mintData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
