...
export interface TokenAccountInterface extends utils.Interface {
    functions: {
        ...
        "transferOwnershipToCurrentOwner()": FunctionFragment;
        "walletType()": FunctionFragment;
        "withdraw(uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "approvalCount" | "approved" | "availableBalance" | "call(address,bytes)" | "call(address,uint256,bytes)" | "currentTokenId" | "delegateCall" | "deployer" | "deposit" | "empty" | "erc721" | "getIntegrity" | "isAuthenticated" | "multiApprove" | "multiRevoke" | "onERC721Received" | "send" | "setPrivilages" | "staticCall" | "transfer" | "transferOwnership" | "transferOwnershipToCurrentOwner" | "walletType" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "transferOwnershipToCurrentOwner", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "transferOwnershipToCurrentOwner", data: BytesLike): Result;
...
export interface TokenAccount extends BaseContract {
    ...
    functions: {
        ...
        transferOwnershipToCurrentOwner(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        transferOwnershipToCurrentOwner(overrides?: CallOverrides): Promise<void>;
        walletType(overrides?: CallOverrides): Promise<string>;
