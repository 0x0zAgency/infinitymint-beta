...
import { InfinityMintDeploymentClass, InfinityMintLinkerDeploymentClass, InfinityMintProjectDeploymentClass, InfinityMintStorageDeploymentClass, InfinityMintValuesDeploymentClass } from '@infinitymint-types/deployments';
/**
 ...
 */
export interface InfinityMintEventEmit<T> extends InfinityMintDeploymentParameters, KeyValue {
    event?: T;
    /**
...
export interface InfinityMintCompiledProject {
     ...
     *
     */
    libraries?: Dictionary<string | InfinityMintDeploymentLocal | InfinityMintDeploymentLive>;
    updates?: Dictionary<InfinityMintProjectUpdate>;
    /**
     *
     */
    links?: Dictionary<InfinityMintCompiledLink> | Dictionary<InfinityMintProjectSettingsLink> | Array<InfinityMintProjectSettingsLink>;
    /**
     ...
     */
    assets?: Array<InfinityMintProjectAsset> | Dictionary<InfinityMintProjectAsset>;
    /**
 ...
 */
export interface InfinityMintTempProject extends InfinityMintCompiledProject, InfinityMintDeployedProject {
    /**
 ...
 *
 */
export interface InfinityMintDeployedProject extends InfinityMintCompiledProject {
    /**
     * the name of the current project
     */
    name: string;
...
export interface InfinityMintProject {
     ...
     * custom infinityLinks which can be linked to the token
     */
    links?: Array<InfinityMintProjectSettingsLink> | Dictionary<InfinityMintProjectSettingsLink>;
    /**
     * @defaultValue 'minter'
     */
    type?: 'minter' | 'project' | 'asset' | 'gem' | 'system' | 'service' | 'library' | 'interface';
    static?: {
        background?: PathLike;
     ...
     * All the possible asset varations of the minter, must be an Array of {@link InfinityMintProjectAsset}
     */
    assets?: Array<InfinityMintProjectAsset> | Dictionary<Array<InfinityMintProjectAsset[]>>;
    /**
     * The settings of the project. The settings key is which deployment the settings should be for, and you can enter what ever you like here.
     *
     * @see {@link InfinityMintProjectSettings}
 ...
 */
export declare class InfinityMintEventEmitter extends EventEmitter {
}
export interface InfinityMintConfigEvents extends InfinityMintEvents {
    changeProject?: (event: InfinityMintEventEmit<string>) => Promise<void | boolean>;
    changeNetwork?: (event: InfinityMintEventEmit<string>) => Promise<void | boolean>;
    destroyed?: (event: InfinityMintEventEmit<string>) => Promise<void | boolean>;
}
export interface InfinityMintNetworkEvents extends InfinityMintEvents {
    ...
    onTransactionPending?: (event: InfinityMintEventEmit<string>) => Promise<void | boolean>;
    onTransactionSuccess?: (event: InfinityMintEventEmit<string>) => Promise<void | boolean>;
    onTransactionFailure?: (event: InfinityMintEventEmit<string>) => Promise<void | boolean>;
}
...
export interface InfinityMintEvents {
     ...
     * @event
     */
    initialized?: (event: InfinityMintEventEmit<void>) => Promise<void | boolean>;
    /**
     ...
     * @event
     */
    disconnected?: (event: InfinityMintEventEmit<any>) => Promise<void | boolean>;
    /**
     ...
     * @event
     */
    preCompile?: (event: InfinityMintEventEmit<InfinityMintProject>) => Promise<void | boolean>;
    /**
     * Will be called when project is compiled
     * @event
     */
    postCompile?: (event: InfinityMintEventEmit<InfinityMintProject>) => Promise<void | boolean>;
    /**
     * Will be called when setup is about to take place. Can return false to abort setup silently.
     * @event
     */
    preSetup?: (event: InfinityMintEventEmit<InfinityMintDeployment>) => Promise<void | boolean>;
    /**
     * @event
     */
    postSetup?: (event: InfinityMintEventEmit<InfinityMintDeployment>) => Promise<void | boolean>;
    /**
     * Will be called when setup is about to take place. Can return false to abort setup silently.
     * @event
     */
    preVerify?: (event: InfinityMintEventEmit<InfinityMintProjectPath | InfinityMintProjectAsset | InfinityMintProjectContent>) => Promise<void>;
    /**
     * @event
     */
    postVerify?: (event: InfinityMintEventEmit<InfinityMintProjectPath | InfinityMintProjectAsset | InfinityMintProjectContent>) => Promise<void>;
    /**
     * Will be called when setup is about to take place. Can return false to abort setup silently.
     * @event
     */
    preCompileSetup?: (event: InfinityMintEventEmit<InfinityMintProjectPath | InfinityMintProjectAsset | InfinityMintProjectContent>) => Promise<void>;
    /**
     * @event
     */
    postCompileSetup?: (event: InfinityMintEventEmit<InfinityMintProjectPath | InfinityMintProjectAsset | InfinityMintProjectContent>) => Promise<void>;
    /**
     * Will be called when deploy complete.
     * @event
     */
    postDeploy?: (event: InfinityMintEventEmit<InfinityMintDeploymentLive[]>) => Promise<void>;
    /**
     * @event
     */
    preDeploy?: (event: InfinityMintEventEmit<InfinityMintDeploymentLive[]>) => Promise<void>;
    /**
     * @event
     */
    gemPreSetup?: (event: InfinityMintEventEmit<InfinityMintGemScript>) => Promise<void>;
    /**
     * @event
     */
    gemPostSetup?: (event: InfinityMintEventEmit<InfinityMintGemScript>) => Promise<void>;
    /**
     * @event
     */
    gemPreDeploy?: (event: InfinityMintEventEmit<InfinityMintDeploymentLive[]>) => Promise<void>;
    /**
     * @event
     */
    gemPostDeploy?: (event: InfinityMintEventEmit<InfinityMintDeploymentLive[]>) => Promise<void>;
    /**
     * @event
     */
     ...
     * @event
     */
    postGem?: (event: InfinityMintEventEmit<InfinityMintGemScript>) => Promise<void>;
    /**
     * @event
     */
    preGem?: (event: InfinityMintEventEmit<InfinityMintGemScript>) => Promise<void>;
    /**
     * @event
     */
    preScript?: (event: InfinityMintEventEmit<InfinityMintScript>) => Promise<void>;
    /**
     * @event
     */
    postScript?: (event: InfinityMintEventEmit<InfinityMintScript>) => Promise<void>;
    /**
     * @event
     */
...
export type InfinityMintEnvironmentKeys = keyof InfinityMintEnvironmentVariables;
/**
...
export interface InfinityMintProjectPath {
     ...
     */
    settings?: boolean | InfinityMintSVGSettings | KeyValue | Dictionary<InfinityMintSVGSettings>;
    description?: string;
    /**
...
export interface InfinityMintConfig {
     ...
     */
    export?: {
        putGems?: (gems: Gem[], infinityConsole: InfinityConsole) => Promise<void>;
        putTokenRenderScripts?: (scripts: any, infinityConsole: InfinityConsole) => Promise<void>;
        putDeployments?: (deployments: InfinityMintDeployment[], project: InfinityMintDeployedProject, infinityConsole: InfinityConsole) => Promise<void>;
        putProject?: (deployedProject: InfinityMintDeployedProject, compiledProject: InfinityMintCompiledProject, project: InfinityMintProject, infinityConsole: InfinityConsole) => Promise<void>;
        putImages?: (images: Dictionary<string>, infinityConsole: InfinityConsole) => Promise<void>;
        putStyles?: (styles: Dictionary<string>, infinityConsole: InfinityConsole) => Promise<void>;
        putResources?: (resources: Dictionary<string>, infinityConsole: InfinityConsole) => Promise<void>;
    };
}
/**
...
export interface InfinityMintScript {
     ...
     */
    reloaded?: (script: InfinityMintScriptParameters) => Promise<boolean | void>;
    /**
...
export interface InfinityMintExportScriptParameters extends InfinityMintScriptParameters {
    location: string;
    publicFolder: string;
...
export interface InfinityMintTemplateScript {
    ...
    meta?: {
        ...
        requirements?: {
            ...
            gems?: string[] | Dictionary<{
                name?: string;
                module?: string;
                location?: string;
                sha256?: string;
            }>;
            base?: 'typescript-boilerplate' | 'javascript-boilterplate' | 'typescript-starterkit' | 'javascript-starterkit' | 'svelte-starterkit';
            ipfsOnly?: boolean;
...
export interface InfinityMintExportScript {
    ...
    description?: string;
    roots?: Array<{
        type?: 'styles' | 'scripts' | 'images' | 'fonts' | 'videos' | 'paths' | 'projects' | 'assets' | 'pages' | 'imports' | 'components' | 'gems' | 'gemComponents' | 'gemPages' | 'gemAssets' | 'deployedProjects' | 'gemDeployments' | 'gemStyles' | 'gemScripts' | 'gemImages' | 'gemFonts' | 'gemVideos' | 'gemPaths' | 'gemResources' | 'content' | 'audio' | 'resources' | 'root' | 'gems' | 'public' | 'deployments';
        onlyName?: boolean;
        useRoot?: boolean;
        usePublic?: boolean;
        location?: string;
 ...
 */
export interface InfinityMintDeployments extends Dictionary<InfinityMintDeployment> {
 ...
 * todo: figure out what this is
 */
export interface InfinityMintLiveDeployments extends Dictionary<InfinityMintDeploymentLive> {
...
export type DeployArgsType = (params: InfinityMintDeploymentParameters) => Promise<string[]> | string[];
/**
...
export type ValuesReturnType = (params: InfinityMintDeploymentParameters) => Promise<number | boolean>;
export interface InfinityMintGemSettings extends InfinityMintProjectSettings {
}
export interface InfinityMintGemDeploymentScript extends InfinityMintDeploymentScript {
...
export interface InfinityMintDeploymentScript {
     ...
     */
    switch?: (params: InfinityMintDeploymentParameters) => Promise<Contract | Contract[]>;
    /**
     * @async
     ...
     */
    cleanup?: (params: InfinityMintDeploymentParameters) => Promise<string[] | void>;
     ...
     */
    update?: (params: InfinityMintDeploymentParameters) => Promise<Contract | Contract[]>;
    /**
