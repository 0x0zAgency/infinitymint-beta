...
export interface DefaultRoyaltyInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "SPLIT_TYPE_MINT" | "SPLIT_TYPE_STICKER" | "approvalCount" | "approved" | "changePrice" | "counter" | "deployer" | "dispenseRoyalty" | "erc721Destination" | "freebies" | "incrementBalance" | "isAuthenticated" | "lastTokenPrice" | "multiApprove" | "multiRevoke" | "originalTokenPrice" | "registerFree" | "setPrivilages" | "stickerSplit" | "tokenPrice" | "transferOwnership" | "values"): FunctionFragment;
...
export interface DefaultRoyalty extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DefaultRoyaltyInterface;
