...
export interface RaritySVGInterface extends utils.Interface {
    functions: {
...
export interface RaritySVG extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RaritySVGInterface;
...
//# sourceMappingURL=RaritySVG.d.ts.map