...
export interface SimpleAnyInterface extends utils.Interface {
    functions: {
...
export interface SimpleAny extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SimpleAnyInterface;
...
//# sourceMappingURL=SimpleAny.d.ts.map